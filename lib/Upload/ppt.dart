...
class UploadPPT extends StatefulWidget {
  String pathPDF = "";
  UploadPPT({required this.pathPDF});
  @override
  _UploadPPTState createState() => _UploadPPTState(pathPDF: pathPDF);
}

class _UploadPPTState extends State<UploadPPT> {
  String pathPDF = "";
  _UploadPPTState({required this.pathPDF});
